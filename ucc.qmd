...
# The team <img src="UCC.png" alt="Logo" style="width: 250px; vertical-align: middle;">
...
<div style="flex: 1; max-width: 120px; text-align: center;">
  ![](Jordan.png){.rounded width=100}

  Jordan Sullivan
</div>

<div style="flex: 1; max-width: 120px; text-align: center;">
  ![](Misty.png){.rounded width=100}

  Misty Wahl
</div>

<div style="flex: 1; max-width: 120px; text-align: center;">
  ![](Nate.png){.rounded width=100}

  Nate Stemen
</div>

<div style="flex: 1; max-width: 120px; text-align: center;">
  ![](Will.png){.rounded width=100}

  Will Zeng
</div>

<div style="flex: 1; max-width: 120px; text-align: center;">
  ![](Nathan.png){.rounded width=100}
